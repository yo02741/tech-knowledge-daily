...
- 每個熱點兩要素缺一不可：**是什麼（小結敘事，含為何現在熱）/ 來源**。「為何爆」欄位已退場——熱度/狀態/走勢由前端徽章傳達，不寫重複數字。
- **版面要賺**：完整卡只給新爆發/上升/顯著變化的話題；持平舊聞進 `tracking` 壓縮條、退燒低熱度退場；當日未歸戶熱點前列進 `fresh`（今日新訊）——每天的報告必須有昨天沒有的內容。
